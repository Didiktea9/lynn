...
from LynnRoBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from LynnRoBot.__main__ import DATA_IMPORT
...
# from LynnRoBot.modules.rules import get_rules
import LynnRoBot.modules.sql.rules_sql as rulessql

# from LynnRoBot.modules.sql import warns_sql as warnssql
import LynnRoBot.modules.sql.blacklist_sql as blacklistsql
from LynnRoBot.modules.sql import disable_sql as disabledsql

# from LynnRoBot.modules.sql import cust_filters_sql as filtersql
# import LynnRoBot.modules.sql.welcome_sql as welcsql
import LynnRoBot.modules.sql.locks_sql as locksql
from LynnRoBot.modules.connection import connected
...
def export_data(update, context):
    ...
    os.remove("LynnRoBot{}.backup".format(chat_id))  # Cleaning file
...
*Only for group owner:*
 ...
 ➤ /import: Reply to the backup file for the butler / Lynn group to import as much as possible, making transfers very easy! \
