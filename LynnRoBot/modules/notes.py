...
import LynnRoBot.modules.sql.notes_sql as sql
from LynnRoBot import LOGGER, JOIN_LOGGER, SUPPORT_CHAT, dispatcher, DRAGONS
from LynnRoBot.modules.disable import DisableAbleCommandHandler
from LynnRoBot.modules.helper_funcs.handlers import MessageHandlerChecker
from LynnRoBot.modules.helper_funcs.chat_status import user_admin, connection_status
from LynnRoBot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from LynnRoBot.modules.helper_funcs.msg_types import get_note_type
from LynnRoBot.modules.helper_funcs.string_handling import (
...
def list_notes(update: Update, context: CallbackContext):
    ...
    msg = "Notes kohchhuah nan `/` leh `#`i hmang thei ang.Entirnan clear tih kha id 3 na ah awm ta se `/3` i ti ang a,`#clear` ti pawhin i kochhuak thei bawk. \n\n Get note by `/notenumber` or `#notename` \n\n  *ID*    *Note* \n"
...
__help__ = """
 ☞︎︎︎ /get <notename>*:* get the note with this notename
 ☞︎︎︎ #<notename>*:* same as /get
 ☞︎︎︎ /notes or /saved*:* list all saved notes in this chat
 ☞︎︎︎ /number *:* Will pull the note of that number in the list
If you would like to retrieve the contents of a note without any formatting, use `/get <notename> noformat`. This can \
be useful when updating a current note
*Admins only:*
 ☞︎︎︎ /save <notename> <notedata>*:* saves notedata as a note with name notename
A button can be added to a note by using standard markdown link syntax - the link should just be prepended with a \
`buttonurl:` section, as such: `[somelink](buttonurl:example.com)`. Check `/markdownhelp` for more info
 ☞︎︎︎ /save <notename>*:* save the replied message as a note with name notename
 ...
 *Example:* 
 ...
 %%%
 Reply 3`
 ☞︎︎︎ /clear <notename>*:* clear note with this name
 ☞︎︎︎ /removeallnotes*:* removes all notes from the group
