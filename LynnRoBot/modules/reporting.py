...
from LynnRoBot import LOGGER, DRAGONS, TIGERS, WOLVES, dispatcher
from LynnRoBot.modules.helper_funcs.chat_status import user_admin, user_not_admin
from LynnRoBot.modules.log_channel import loggable
from LynnRoBot.modules.sql import reporting_sql as sql
...
*Admins only:*
 ➤ /reports <on/off>*:* change report setting, or view current status.
   ☛︎ If done in pm, toggles your status.
   ☛︎ If in group, toggles that groups's status.
"""
